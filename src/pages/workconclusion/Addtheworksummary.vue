<template>
    <div class="commentontheinput">
        ...
        <group title="工作感悟与自我认知总结 ">
            <x-textarea v-model="model.workfeeling" :max="1000" placeholder="请填写详本周工作总结"></x-textarea>
        </group>
        <group title="自我存在的问题与改进措施">
            <x-textarea v-model="model.problem" :max="500" placeholder="请填写下周计划"></x-textarea>
        </group>
        <group title="下个月的工作或成长计划">
            <x-textarea v-model="model.nextmonthplan" :max="500" placeholder="请填写问题反思与改进方案"></x-textarea>
        </group>
